    ...
    return (
        <div className="group relative transition border rounded-lg hover:shadow-lg space-y-5 p-6">
            ...
            <div className="space-y-2">
                <h5 className="text-2xl font-bold tracking-tight transition group-hover:text-indigo-500">First feature</h5>
                <p className="text-gray-500">Neque Dolor, fugiat non cum doloribus aperiam voluptates nostrum.</p>
            </div>
            <Link href="/" className="flex font-medium items-center justify-between group-hover:text-indigo-500">
                <span>Read more</span>
